...
const Rainy = () => {
  return (
    ...
    <div className="w-full">
      <img src="images/rainy6.jpg" alt="" />

      <div className="w-3/5 h-48  absolute left-0 bottom-24 text-white text-9xl p-8 flex ">
        <span className="px-4 animate-bounce">16°</span>
        <div><div className="text-6xl">Amritsar</div>
        <div className="text-3xl mt-4">4:25-Wed,3 March'23</div>
        </div>
        <img src="images/cloud.png" alt="" className="px-8  animate-pulse" />
      </div>
